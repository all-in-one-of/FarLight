...
namespace fl
{
	...
	public class JetParticle : MonoBehaviour
	{
		...
		private ShipController m_Jet; // The jet that the particle effect is attached to
		...
		private ShipController FindAeroplaneParent()
		{
			// get reference to the object transform
			var t = transform;

            // traverse the object hierarchy upwards to find the ShipController
			...
			throw new Exception(" ShipController not found in object hierarchy");
		}
	}
}
